...
/**
 * Hoe-Item Base Class for easier creation
 */
public abstract class AbstractHoe extends ItemHoe implements ItemInterface {
	public String oreDictName = null;

	/**
	 * AbstractHoe constructor
	 *
	 * @param name Name of the Item
	 * @param material Material of the Tool
	 */
	public AbstractHoe(String name, ToolMaterial material) {
		super(material);
