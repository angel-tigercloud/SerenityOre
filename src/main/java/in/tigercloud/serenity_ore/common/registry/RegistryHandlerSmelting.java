...
public class RegistryHandlerSmelting {
	...
	public static void init() {
		GameRegistry.addSmelting(ModBlocks.SERENITY_ORE, new ItemStack(ModItems.SERENITY_PEARL), 0.7f);
		GameRegistry.addSmelting(ModBlocks.SERENITY_ORE_NETHER, new ItemStack(ModItems.SERENITY_PEARL), 0.9f);
		GameRegistry.addSmelting(ModBlocks.SERENITY_ORE_END, new ItemStack(ModItems.SERENITY_PEARL), 1.1f);
